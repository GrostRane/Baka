...
#define WINDOWS_8_1  9

#define WINDOWS_10 10
#define WINDOWS_11  11
...
#define ROUND_DOWN(n, align)    (((unsigned long)n) & ~((align) - 1l))
#define ROUND_UP(n, align)      ROUND_DOWN(((unsigned long)n) + (align) - 1, (align))
#define ROUND_SIZE(size)        (MAX(16, ROUND_UP(size, 16)))


struct AllSyscallNumber
{
    short   ntClose;
    short   QueryProcessInformathion;
    short   NtMapViewOfSection;
    short NtCreateSection;
